...
export function fetchAQI(userSelection){
  ...
  console.log("AQI location", userSelection);
  let aqi;
  let currentIndex = {};
  let hourlyIndex = {};

  fetch(`${vars.aqiEndpoint}?${latitude}&${longitude}&${vars.aqiCurrent}&${vars.aqiHourly}&${vars.aqiForecast}&${timezone}`, vars.requestOptions)
